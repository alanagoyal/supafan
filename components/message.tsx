    ...
    <div className="py-2 mx-10 max-width-5-xl">
      ...
      <div className="my-4 flex justify-center">
        <input
          ...
          id="message"
          type="text"
          className="w-full rounded-md bg-supabase-gray-500 border-gray-300 shadow-sm py-2 px-3 my-4 focus:outline-none focus:ring-supabase-green-500 focus:border-supabase-green-500 text-white sm:text-sm"
